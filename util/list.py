from pyteal import Len, Concat, Extract, ExtractUint16, ExtractUint32, ExtractUint64, Substring, Itob
...
class List:
    ...
    def get_bytes(self, idx: TealType.uint64) -> Expr:
        return Substring(self.get(), idx*self.byte_size, (idx + Int(1)) * self.byte_size)
